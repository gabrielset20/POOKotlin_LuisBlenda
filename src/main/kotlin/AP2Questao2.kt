class AP2Questao2 {
    companion object {
        ...
        fun main(args: Array<String>) {
            ...
            // Exibir o total por genero
            val quantidadeDeGeneros = supermercado.getQuantidadeDeGenerosUnicos()
            println("Quantidade de gêneros diferentes: $quantidadeDeGeneros")
